...
hist(age, breaks=50, main="Age Distribution of Account Holders",
...
summary(income)
# plot the histogram
hist(income, breaks=20, xlab="Income", main="Histogram of Income")
# density plot
...
DF <- read.csv("C:/Users/kavit/Desktop/BigDataAnalytics(IME780AN)/Data_Code/zipIncome.csv", header=TRUE, sep=",")
